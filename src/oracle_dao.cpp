...
{12,4130,1,0,0,
5,0,0,1,0,0,27,36,0,0,4,4,0,1,0,1,97,0,0,1,10,0,0,1,10,0,0,1,10,0,0,
36,0,0,2,113,0,3,65,0,0,6,6,0,1,0,1,97,0,0,1,3,0,0,1,3,0,0,1,3,0,0,1,3,0,0,1,
97,0,0,
75,0,0,3,0,0,29,77,0,0,0,0,0,1,0,
90,0,0,4,0,0,30,92,0,0,0,0,0,1,0,
};
...

{
 ...
 sqlstm.sqhstv[0] = (         void  *)user_passwd;
...
ogout_time,duration,log_ip) values (:b0,:b1,:b2,:b3,:b4,:b5)";
        ...
        sqlstm.sqhstv[2] = (         void  *)&login_time;
        ...
        sqlstm.sqhstv[3] = (         void  *)&logout_time;
